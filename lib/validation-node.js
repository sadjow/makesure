...
//   applyArgs = typeof this.validation.validate == 'function' ? [obj[this.attr]] : this.computedValidationArgs;
//   if (typeof this.validation.validate == 'function') {
//     return this.validation.apply(null, [obj[this.attr]])
//   } else {
//     var deferred = q.defer();
//     var result = this.validation.apply(null, this.computedValidationArgs)
//     var error = null;
...
//       });
//     } else {
//       if(result && !this.negative) {
//         var error = {};
//         deferred.resolve(error[this.attr] = [this.message]);
//       } else {
